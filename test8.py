...
small_eval = dataset["validation"].shuffle(seed=42).select(range(600))
...
small_train = small_train.remove_columns(["sentence"])
small_eval = small_eval.remove_columns(["sentence"])
