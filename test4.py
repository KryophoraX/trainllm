...
small_train = dataset["train"].shuffle(seed=42).select(range(1500))
...
def tokenize_function(examples):
    # amazon_polarity has "title" and "content"
    texts = [
        f"{t} {c}"
...
small_train = small_train.remove_columns(["title", "content"])
small_eval = small_eval.remove_columns(["title", "content"])
